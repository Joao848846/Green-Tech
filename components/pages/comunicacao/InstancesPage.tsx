...
import { FetchedInstanceConnection, ApiError } from '../../../types'; 
            ...
            {instances.map((conn) => (
              ...
              >
                <div className="space-y-2 text-sm">
                  ...
                  {conn.integration && <p><span className="font-semibold text-futuristic-text-secondary">Integração:</span> {conn.integration}</p>}
                </div>
              </Card>
            ))}
          </div>
